...
export function Backtest1CumulativeChart({ trades }) {
  ...
  return (
    <div className="backtest1-chart-block">
      <h3 className="backtest1-chart-label">Cumulative PnL % (line)</h3>
      <p className="backtest1-chart-hint">
        Running sum of each trade&apos;s PnL % at exit (same basis as the table;
        not compounded account equity).
      </p>
